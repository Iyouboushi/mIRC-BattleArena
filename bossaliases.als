...
generate_pirate_firstmatey {
  ...
  if (%current.battlestreak < 50) { writeini $char(%monster.name) info SpawnAfterDeath Silverhook }
  if (%current.battlestreak >= 50) { writeini $char(%monster.name) info SpawnAfterDeath BlackBeard }
